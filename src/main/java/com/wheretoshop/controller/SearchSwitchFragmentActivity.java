...
public abstract class SearchSwitchFragmentActivity extends ActionBarActivity implements FragmentSwitcher {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		searchSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) { changeFragment(isChecked); }
		});
